<?php
    ...
    */
    ...
    <div id="poststuff" > 
        <div id="post-body" class="metabox-holder columns-2" >  
            ...
            <div id="postbox-container-1" class="postbox-container" > 
                ...
                <div class="postbox"> 
                    <h3 class="hndle"><span></span>OptinMonster converts website visitors into subscribers and customers</h3> 
                    <div class="inside">
                        <center><a href="http://shareasale.com/r.cfm?b=632217&amp;u=675922&amp;m=49337&amp;urllink=&amp;afftrack=" target="_blank" ><img src="<?php echo plugins_url( 'images/300x250.png', __FILE__ );  ?>" width="250"  border="0"></a></center>
                        <div style="margin:10px 5px">
                        </div>
                    </div></div>
                <div class="postbox"> 
                    <h3 class="hndle"><span></span>Free WordPress Form Builders</h3> 
                    <div class="inside">
                        <center><a href="http://shareasale.com/r.cfm?b=812700&amp;u=675922&amp;m=63061&amp;urllink=&amp;afftrack=" target="_blank" ><img src="<?php echo plugins_url( 'images/ninja-300x250.png', __FILE__ );  ?>" width="250"  border="0"></a></center>
                        <div style="margin:10px 5px">
                        </div>
                    </div></div>
            ...
            <div id="post-body" class="metabox-holder columns-2">
                ...
                <div id="postbox-container-1" class="postbox-container"> 
                    <div class="postbox"> 
                        ...
                        <div class="postbox"> 
                        <h3 class="hndle"><span></span>WordPress Backup Made Easy</h3> 
                        <div class="inside">
                            <center><a href="http://shareasale.com/r.cfm?b=860238&amp;u=675922&amp;m=65564&amp;urllink=&amp;afftrack=" target="_blank" ><img src="<?php echo plugins_url( 'images/duplicator.jpg', __FILE__ );  ?>" width="250"  border="0"></a></center>
                            <div style="margin:10px 5px">
                            </div>
                        </div></div>
                                    ...
                                    <div class="stuffbox" id="namediv" style="width:100%">
                                        ...
                                        <div class="inside" id="fileuploaddiv">
                                            ...
                                            <div class="uploader">
                                               ...
                                               <a href="javascript:;" class="niks_media" id="myMediaUploader"><b>Click here add image</b></a>
                    ...
                    <div id="post-body" class="metabox-holder columns-2">
                        <div id="post-body-content">
                            ...
                            <div id="divResponsiveSliderPlusLightboxMain_admin">
                                <div class="responsiveSlider" style="margin-top: 2px !important;visibility: hidden;">
                                    <?php
                                        global $wpdb;
    ...
    <div style="width: auto;postion:relative" id="divSliderMain">
        <div class="responsiveSliderWithResponsiveLightbox" style="margin-top: 2px !important;visibility: hidden;">
            <?php
                global $wpdb;          
                $imageheight=$settings['imageheight'];
                $imagewidth=$settings['imagewidth'];
